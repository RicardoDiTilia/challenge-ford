...
export const leads: Lead[] = [
  ...
  },
  {
    ...
    dealership: 'Ford Brasília',
  },
  {
    id: 'L007',
    customer: 'Bruno Almeida',
    vehicle: 'Ford Bronco Sport 2023',
    km: 36200,
    probability: 67,
    service: 'Alinhamento e balanceamento',
    parts: ['Serviço de alinhamento'],
    stock: 'ok',
    channel: 'whatsapp',
    region: 'Sudeste',
    urgency: 'mid',
    script:
      'Bruno, identificamos desgaste assimétrico nos pneus dianteiros. Vamos agendar?',
